...
public class DependencyLoader {
    ...
    static void loadDeps(Runnable onComplete) throws URISyntaxException, InterruptedException, ParserConfigurationException, SAXException, IOException, ExecutionException {
